    ...
    <div className={`flex flex-col h-full bg-gray-900 ${className}`}>
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-700">
        <div className="flex items-center space-x-2">
          ...
          <h2 className="text-lg font-semibold text-white">Markdown 编辑器</h2>
        </div>
      ...
      >
        <textarea
          ...
          className="w-full h-full p-4 bg-gray-900 text-gray-100 border-none outline-none resize-none font-mono text-sm leading-relaxed"
          style={{
